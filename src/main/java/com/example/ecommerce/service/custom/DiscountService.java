package com.example.ecommerce.service.custom;
...
public class DiscountService extends CRUDService<Discount, UUID, DiscountDTO> {
    ...
    @Override
    public Discount getEntityFromDTO(DiscountDTO dto){ return this.adapter.fromDto(dto); }

    @Override
    public DiscountDTO getDTOFromEntity(Discount entity){ return this.adapter.fromEntity(entity); }
