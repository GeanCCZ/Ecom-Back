...
import com.example.ecommerce.service.custom.ReviewService;
...
public class ReviewServiceTest {
    ...
    public void testReviewCreate(){
        ...
        assertEquals(newReview.avaliationValue(), createdReview.avaliationValue());
    ...
    public void testReviewUpdate(){
        ...
        assertEquals(updateReviewDTO.avaliationValue(), updatedReview.avaliationValue());
